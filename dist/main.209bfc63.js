...
var xObject = JSON.parse(x); //字符串变成对象

var hashMap = xObject || [{ logo: 'A', url: 'https://www.acfun.cn' }, { logo: 'B', url: 'https://www.bilibili.com' }];
var removeX = function removeX(url) {
  return url.replace('https://', '').replace('http://', '').replace('www.', '').replace('.com', '').replace('.cn', '').replace(/\/.*/, ''); //删除 /开头的内容
};
...
//# sourceMappingURL=main.209bfc63.map